...
class KnowledgeGraphApp:
    ...
    # 功能按钮
        ...
        # 跳过登录按钮，放在底部
        skip_button = ttk.Button(login_frame, text="跳过登录", command=self.show_main_menu)
        skip_button.pack(side="bottom", pady=10, fill="x")
...
# 转换逻辑
    ...
    # 返回按钮
       return_button = ttk.Button(frame, text="返回主菜单", command=self.show_main_menu)
